...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ykl(c@d%suhxao%t37pce@@b!u)f5syt@x%ksoe8=at76t&=+c')
...
# Security & SSL configuration (Automatically enabled in Production when DEBUG=False)
if not DEBUG:
